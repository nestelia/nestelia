...
Defined in: [packages/scheduler/src/interfaces/scheduler.interface.ts:46](https://github.com/nestelia/nestelia/blob/main/packages/scheduler/src/interfaces/scheduler.interface.ts#L46)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="cancelonshutdown"></a> `cancelOnShutdown?` | `boolean` | Whether to cancel the timeout when the application is shutting down | - | [packages/scheduler/src/interfaces/scheduler.interface.ts:50](https://github.com/nestelia/nestelia/blob/main/packages/scheduler/src/interfaces/scheduler.interface.ts#L50) |
