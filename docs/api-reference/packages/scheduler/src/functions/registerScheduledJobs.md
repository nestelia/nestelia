...
Defined in: [packages/scheduler/src/utils/scheduler.utils.ts:45](https://github.com/nestelia/nestelia/blob/main/packages/scheduler/src/utils/scheduler.utils.ts#L45)
