...
| <a id="maxmessagesize"></a> `maxMessageSize?` | `number` | Maximum message size in bytes (default: 10MB) | [packages/rabbitmq/src/interfaces/rabbitmq.interface.ts:85](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/interfaces/rabbitmq.interface.ts#L85) |
