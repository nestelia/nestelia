# Class: NullMessageError

Defined in: [packages/rabbitmq/src/amqp/errors.ts:14](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/amqp/errors.ts#L14)
...
```ts
new NullMessageError(): NullMessageError;
```

Defined in: [packages/rabbitmq/src/amqp/errors.ts:15](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/amqp/errors.ts#L15)
