...
Defined in: [packages/rabbitmq/src/amqp/errors.ts:21](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/amqp/errors.ts#L21)
...
```ts
new ChannelNotAvailableError(): ChannelNotAvailableError;
```

Defined in: [packages/rabbitmq/src/amqp/errors.ts:22](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/amqp/errors.ts#L22)
