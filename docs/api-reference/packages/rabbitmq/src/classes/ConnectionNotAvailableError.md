# Class: ConnectionNotAvailableError

Defined in: [packages/rabbitmq/src/amqp/errors.ts:28](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/amqp/errors.ts#L28)
...
```ts
new ConnectionNotAvailableError(): ConnectionNotAvailableError;
```

Defined in: [packages/rabbitmq/src/amqp/errors.ts:29](https://github.com/nestelia/nestelia/blob/main/packages/rabbitmq/src/amqp/errors.ts#L29)
