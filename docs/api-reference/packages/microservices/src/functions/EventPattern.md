...
Defined in: [packages/microservices/src/decorators/event-pattern.decorator.ts:22](https://github.com/nestelia/nestelia/blob/main/packages/microservices/src/decorators/event-pattern.decorator.ts#L22)
