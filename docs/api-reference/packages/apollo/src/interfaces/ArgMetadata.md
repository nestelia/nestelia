...
Defined in: [packages/apollo/src/decorators/types.ts:147](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L147)
...
| <a id="kind"></a> `kind` | `"arg"` | - | [packages/apollo/src/decorators/types.ts:148](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L148) |
| <a id="name"></a> `name` | `string` | Argument name. | [packages/apollo/src/decorators/types.ts:151](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L151) |
| <a id="nullable"></a> `nullable?` | `boolean` | Whether nullable. | [packages/apollo/src/decorators/types.ts:157](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L157) |
