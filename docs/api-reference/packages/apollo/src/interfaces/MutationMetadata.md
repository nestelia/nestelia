...
Defined in: [packages/apollo/src/decorators/types.ts:43](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L43)
...
| <a id="kind"></a> `kind` | `"mutation"` | - | - | [packages/apollo/src/decorators/types.ts:44](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L44) |
| <a id="methodname"></a> `methodName` | `string` | - | - | [packages/apollo/src/decorators/types.ts:45](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/types.ts#L45) |
