...
Defined in: [packages/apollo/src/decorators/info.decorator.ts:35](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/info.decorator.ts#L35)
