...
Defined in: [packages/apollo/src/helpers/register-enum-type.ts:32](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/helpers/register-enum-type.ts#L32)
