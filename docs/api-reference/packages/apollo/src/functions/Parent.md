...
Defined in: [packages/apollo/src/decorators/parent.decorator.ts:38](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/decorators/parent.decorator.ts#L38)
