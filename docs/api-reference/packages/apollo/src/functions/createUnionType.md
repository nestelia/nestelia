...
Defined in: [packages/apollo/src/helpers/create-union-type.ts:28](https://github.com/nestelia/nestelia/blob/main/packages/apollo/src/helpers/create-union-type.ts#L28)
