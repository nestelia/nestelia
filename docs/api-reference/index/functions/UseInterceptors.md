...
Defined in: [packages/core/src/interceptors/use-interceptors.decorator.ts:12](https://github.com/nestelia/nestelia/blob/main/packages/core/src/interceptors/use-interceptors.decorator.ts#L12)
